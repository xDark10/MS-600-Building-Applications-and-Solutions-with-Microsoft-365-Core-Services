# Exercise 2: Bots in channels and group chats
...
![Screenshot of selecting the Manage team option](../../Linked_Image_Files/04-04-05-channel-app-01.png)

Select the **Apps** tab and then **Upload a custom app**.

![Screenshot of the Apps tab of the Manage Team page](../../Linked_Image_Files/04-04-05-channel-app-02.png)
...
![Screenshot of the conversation with incorrect response](../../Linked_Image_Files/04-04-05-channel-app-03.png)
...
![Screenshot of the gulp task running the webpack task](../../Linked_Image_Files/04-04-05-channel-app-04.png)

Once that task completes, @mention the bot again.

![Screenshot of the correct bot response](../../Linked_Image_Files/04-04-05-channel-app-05.png)
