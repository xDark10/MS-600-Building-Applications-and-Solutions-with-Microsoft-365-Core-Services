...
Locate and open the bot in the file **./src/server/planetBot.ts**.

Update the `import` statement for the **botbuilder** package to include the `MessagingExtensionQuery` `MessageExtensionResponse` objects:
