...
- **Supported account types**: Accounts in this organizational directory only (Contoso only - Single tenant)
    ...
    ![Screenshot of the Register an application page](../../Linked_Image_Files/2-Graph/access-user-data//azure-ad-portal-new-app-01.png)
...
![Screenshot of the Configure Desktop + devices panel](../../Linked_Image_Files/2-Graph/access-user-data//azure-ad-portal-new-app-03.png)
...
![Screenshot of the API Permissions navigation item](../../Linked_Image_Files/2-Graph/access-user-data//azure-ad-portal-new-app-permissions-01.png)
...
15. Enter **User.R** in the **Select permissions** search box and select the **User.Read.All** permission, followed by the **Add permission** button at the bottom of the panel.
...
15. Add the following code to request all users from the current organization and write them to the console.
...
16. Run the following command in a command prompt to ensure the developer certificate has been trusted:

```console
dotnet dev-certs https --trust
```

17. Run the following command in a command prompt to compile the console application:

```console
dotnet build
```

18. Run the following command to run the console application:
...
19. The application will write information about all users in the organization to the console:
...
4. After you've logged in, you'll see the details of the signed in user written to the console.
...
5. After you've logged in, you'll see the details of the user you selected.
