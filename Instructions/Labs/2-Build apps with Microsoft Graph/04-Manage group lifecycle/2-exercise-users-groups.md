# Exercise 2: Users and their groups
...
9. Enter **Directory.R** in the **Select permissions** search box and select the **Directory.Read.All** permission. Then select the **Add permission** button at the bottom of the panel to add the permissions to the app.
...
11. Run the following commands in a command prompt to compile and run the console application:
...
12. The application will display the groups in the organization of which the current user is a member:
...
4. After you've logged in, you'll see the results of all groups in the organization the current user owns:
